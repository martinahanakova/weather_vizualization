...
class MarkerModel(QAbstractListModel):
    ...
    def roleNames(self):
        return {MarkerModel.PositionRole: b"position_marker", MarkerModel.ColorRole: b"color_marker", MarkerModel.NameRole: b"name_marker", MarkerModel.ValueRole: b"value_marker"}
